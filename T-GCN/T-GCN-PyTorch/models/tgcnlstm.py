...
class TGCNCell(nn.Module):
    def __init__(self, adj, input_dim: int, hidden_dim: int, cell_dim: int):
        ...
        self.graph_conv1 = TGCNGraphConvolution(
            self.adj, self._hidden_dim, self._hidden_dim * 3, bias=1.0
        )
    ...
    def forward(self, inputs, hidden_state, cell):
        ...
        c = torch.tanh(self.graph_conv2(inputs, hidden_state))
        # h := u * h + (1 - u) * c
